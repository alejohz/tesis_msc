...
RcppExport SEXP robetsTargetFunctionInit(SEXP p_y, SEXP p_errortype, SEXP p_trendtype,
		...
		SEXP p_alpha, SEXP p_beta, SEXP p_gamma, SEXP p_phi, SEXP p_sigma0, SEXP p_initstate, SEXP p_k, SEXP p_psifun, SEXP p_rho) {
  ...
  std::string psifun = Rcpp::as< std::string >(p_psifun);
  ...
  bool givenK = Rcpp::as<bool>(p_givenK);
	...
	sp->init(y, errortype, trendtype, seasontype, damped, lower, upper, opt_crit,
			...
			alpha, beta, gamma, phi, sigma0, initstate, k, psifun);
